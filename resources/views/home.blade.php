...
<head>
    ...
    <!-- APP CSS -->
    <link rel="stylesheet" href={{ asset('asset/dashboard/css/bootstrap.min.css')}} >
    <link rel="stylesheet" href={{ asset('asset/dashboard/css/grid.css')}} >
...
<body class="sidebar-expand">
    ...
    <div class="sidebar">
        <div class="sidebar-logo">
            <a href="index.html">
                <img src={{ asset('asset/dashboard/images/inova2.png')}} alt="ok">
            </a>
            ...
            <ul class="sidebar-menu tf">
                ...
                <li class="sidebar-submenu">
                    ...
                    <ul class="sidebar-menu sidebar-menu-dropdown-content">
                        ...
                        <li>
                            <a href="Tagihan-pemeriksaan.html">
                                Tagihan Pemeriksaan
                            </a>
                        </li>
                        <li>
                            <a href="tagihan-tindakan.html">
                                Tagihan Tindakan
                            </a>
                        </li>
                    </ul>
    ...
    <script src= {{ asset('asset/dashboard/libs/jquery/jquery.min.js') }} ></script>
    <script src= {{ asset('asset/dashboard/libs/moment/min/moment.min.js') }} ></script>
    <script src= {{ asset('asset/dashboard/libs/bootstrap/js/bootstrap.bundle.min.js') }} ></script>
    <script src= {{ asset('asset/dashboard/libs/peity/jquery.peity.min.js') }} ></script>
    <script src= {{ asset('asset/dashboard/libs/chart.js/Chart.bundle.min.js') }} ></script>
    <script src= {{ asset('asset/dashboard/libs/owl.carousel/owl.carousel.min.js') }} ></script>
    <script src= {{ asset('asset/dashboard/libs/bootstrap/js/bootstrap.min.js') }} ></script>
    <script src= {{ asset('asset/dashboard/libs/apexcharts/apexcharts.js') }} ></script>
    <script src= {{ asset('asset/dashboard/libs/simplebar/simplebar.min.js') }} ></script>
