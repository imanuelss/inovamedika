        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('pegawai.update', $ewos->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nip') is-invalid @enderror"
                                    name="nip" value="{{ old('nip', $ewos->nip) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('posisijabatan') is-invalid @enderror"
                                    name="posisijabatan" value="{{ old('posisijabatan', $ewos->posisijabatan) }}" required>

                                <!-- error message untuk posisijabatan -->
                                @error('posisijabatan')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
